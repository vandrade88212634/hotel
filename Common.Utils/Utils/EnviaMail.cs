...
namespace EnviaMail
{
    public class Mail
    {
        ...
        string DE = GeneralMessages.From; //nuestro usuario de smtp
        string PASS = GeneralMessages.Password; //nuestro password de smtp
        ...
        public bool enviaMail()
        {
            ...
            try
            {
                ...
                System.Net.Mail.SmtpClient smtpMail = new System.Net.Mail.SmtpClient(GeneralMessages.Host);
                ...
                smtpMail.Host = GeneralMessages.Host; //agregamos el servidor smtp
                smtpMail.Port = Convert.ToInt32(GeneralMessages.Port); //le asignamos el puerto, en este caso gmail utiliza el 465
